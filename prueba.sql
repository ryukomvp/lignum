-- SELECT p.nombre_producto, p.descripcion_producto, p.codigo_producto, t.tipo_material, COUNT(d.id_producto) as cantidad
-- FROM producto p
...
-- SELECT c.nombre_cliente, c.usuario_publico, COUNT (d.id_producto) as cantidad  
-- FROM pedido p 
...
-- SELECT d.id_detalle_pedido, d.id_pedido, d.id_producto, d.precio_producto, d.cantidad 
